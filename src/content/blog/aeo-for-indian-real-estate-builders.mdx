...
tags: ["AEO", "GEO", "Real estate India", "ChatGPT", "Perplexity", "AI Overviews"]
---
...
## Case study: Exora Farms — sold 80 acres via Meta, now setting up to be cited in three AI engines

Exora Farms is a premium agri-investment project at Palsamudram, Andhra Pradesh (₹33L+ per acre, 70:30 revenue-share with land owners, RERA-registered). We built the platform, ran the paid funnel, and set up the foundational AEO layer.
...
Read the [full Exora Farms case study](/work/exora-farms) for the platform → paid → organic → CRM playbook.
